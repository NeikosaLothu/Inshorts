  ...
  render(){
    ...
    return(
        <View style={{backgroundColor: "#F6F6F6", flex: 1, paddingTop: "17%"}}>
            <Image source={require("../assets/banner.png")} style={{height: 75, width: "100%"}} resizeMode="contain" />
          ...
          <View style={{flexDirection: "row", width:"90%", marginHorizontal: "5%"}}>
            ...
            />
            <TouchableOpacity onPress={()=>this.setState({isHidden: !this.state.isHidden})} style={{position: "absolute", right: 10, top: 23}}>
